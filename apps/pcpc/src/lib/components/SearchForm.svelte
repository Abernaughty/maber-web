...
<style>
  .search-form { display: flex; align-items: flex-end; gap: 12px; margin-bottom: 16px; }
  ...
  @media (max-width: 768px) { .search-form { flex-direction: column; align-items: stretch; } .search-fields { flex-direction: column; } .get-price-btn { padding: 12px 20px; min-height: 44px; } }
</style>
